...
-------
#### 소감 
20210831최우진 : 자바스크립트로 다 해보았던 작업들이라 MFC와 Dev-CPP에서 그래픽을 다루는 작업을 그렇게 어렵지 않게 시도해 볼 수 있었던 것 같습니다. 주차가 지날수록 그래픽 프로그래밍에 대한 자신감이 생기는거 같아 기쁩니다. 앞으로도 더 열심히 하는 자신이 될 수 있도록 노력하겠습니다.
